...
public class FragmentBlockedMails extends Fragment {
    View view;
    private RecyclerView recyclerView;
    private  RecyclerView.Adapter adapter;
    private List<EmailItems> emailitems;
    private FloatingActionButton btnCompose;
    public String URL="http://192.168.43.73:5001/api/fetch/mail";
    DbHelper db;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_blocked_mails, container, false);
        CreateList();
        composeEmail();
